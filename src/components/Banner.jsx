...
const Banner = (props) => {
    ...
    return (
        <div className="flex flex-col " id={props.id}>
            <div className="flex flex-col order-2 justify-center items-center ">
            ...
            <img className="order-1 mt-[12px]" src="White-Sneakers.svg" />
...
export function CarouselDemo() {
    return (
        ...
        ]} className="w-[375px] h-[662px] ">
            <CarouselContent>
                {Array.from({ length: 5 }).map((_, index) => (
                    <CarouselItem key={index} className={" "}>
                        <div className=" ">
                            <Card className="bg-light-gray-3 border-none">
                                <CardContent className="flex h-[662px] justify-center p-0">
